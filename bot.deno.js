...
By default, ||spoiler|| and __underline__ are ignored, because these styles are not available in most markdown standards\\.

To force convert "spoiler" and "underline" into a HTML style, add \\!unstable at the beginning of your rich text\\.`, { parse_mode: "MarkdownV2" }));

bot.command("source", (ctx) => ctx.reply("Welcome! Up and running.")); 
